...
> Branch: `codex/security-hardening-e2e-detector-pipeline-v15`
...
| `hardened_authorized` | `none` | `mislabel_receipt_source` | `none` | `none` | `identity_approval` | `()` | `()` | `()` | `None` | `False` | `0` |
